...
-- ============================================================================
-- Standalone window (temporary, replaced by settings panel in epic-3)
-- ============================================================================

function NXR.ToggleMainFrame()
    if not NXR.mainFrame then
        ...
        NXR.CreateChallengesPanel(content)
        NXR.mainFrame = f
    end

    if NXR.mainFrame:IsShown() then
        NXR.mainFrame:Hide()
    else
        NXR.mainFrame:Show()
    end
